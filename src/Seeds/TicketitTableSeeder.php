...
namespace Hassanfayyaz19\Ticketit\Seeds;
...
class TicketitTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        foreach ($this->statuses as $name => $color) {
            $status = \Hassanfayyaz19\Ticketit\Models\Status::create([
                'name'  => $name,
                'color' => $color,
            ]);
        }
        ...
        foreach ($this->categories as $name => $color) {
            $category = \Hassanfayyaz19\Ticketit\Models\Category::create([
                'name'  => $name,
                'color' => $color,
            ]);
        ...
        foreach ($this->priorities as $name => $color) {
            $priority = \Hassanfayyaz19\Ticketit\Models\Priority::create([
                'name'  => $name,
                'color' => $color,
            ]);
        }
        $categories_qty = \Hassanfayyaz19\Ticketit\Models\Category::count();
        $priorities_qty = \Hassanfayyaz19\Ticketit\Models\Priority::count();
        $statuses_qty = \Hassanfayyaz19\Ticketit\Models\Status::count();
        ...
        for ($u = 1; $u <= $this->users_qty; $u++) {
            ...
            for ($t = 1; $t <= $tickets_qty; $t++) {
                ...
                $category = \Hassanfayyaz19\Ticketit\Models\Category::find($rand_category);
                ...
                $ticket = new \Hassanfayyaz19\Ticketit\Models\Ticket();
                ...
                for ($c = 1; $c <= $comments_qty; $c++) {
                    ...
                    $comment = new \Hassanfayyaz19\Ticketit\Models\Comment();
