...
class CommentsController extends Controller
{
    ...
    {
        $this->middleware('Hassanfayyaz19\Ticketit\Middleware\IsAdminMiddleware', ['only' => ['edit', 'update', 'destroy']]);
        $this->middleware('Hassanfayyaz19\Ticketit\Middleware\ResAccessMiddleware', ['only' => 'store']);
    }
