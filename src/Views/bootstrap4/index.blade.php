...
@section('footer')
	<script src="https://cdn.datatables.net/v/bs4/dt-{{ Hassanfayyaz19\Ticketit\Helpers\Cdn::DataTables }}/r-{{ Hassanfayyaz19\Ticketit\Helpers\Cdn::DataTablesResponsive }}/datatables.min.js"></script>
	<script>
	    $('.table').DataTable({
	        processing: false,
	        serverSide: true,
